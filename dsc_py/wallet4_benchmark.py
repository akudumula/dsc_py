...
private_key = read_one_block("dsc_py/dsc-key-wallet4.yaml")["private_key"]
results=[0] * 128
...
def run():
    ...
    sender = output["wallet4"]["public_key"]
    ...
    for i in range(0,128):
        while True:
            ...
            if random_number != 4:
                break
        recepient_address = output[f"wallet{random_number}"]["public_key"]
